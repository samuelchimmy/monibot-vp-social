...
*   **Twitter Write Access:** Utilizes the official Twitter API v2 with OAuth 2.0 for reliable posting.
...
*   **Database Integration:** Seamlessly integrates with the transactions table created by the MoniBot Worker bot, ensuring up-to-date transaction awareness.
...
├── index.js # Main loop (starts all components)
├── gemini.js # Generates replies using Google Gemini
├── twitter-oauth2.js # Handles Twitter OAuth 2.0 authentication and posting
├── database.js # Supabase integration (read)
└── campaigns.js # Campaign scheduling and content generation
code
Code
## 🚀 How It Works
...
5.  **Verify Connection:** The logs should show "✅ Twitter OAuth 2.0 initialized and token refreshed."
